...
exports.validateUserActiveGamesBodyPOST = [
    ...
    body('*.inProgressGames.*.moves.*.puzzleCurrentState', 'puzzle current state did not match whitelist').whitelist("0123456789"),
    body('*.inProgressGames.*.moves.*.puzzleCurrentState', 'puzzle current state is not of correct length').isLength({ min: 81, max: 81 }),
    body('*.inProgressGames.*.moves.*.puzzleCurrentNotesState', 'puzzle current notes state state did not match whitelist').whitelist("01"),
    body('*.inProgressGames.*.moves.*.puzzleCurrentNotesState', 'puzzle current notes state state is not of correct length').isLength({ min: 9, max: 729 }),
...
exports.validateUserActiveGamesParameters = [
    ...
    query('*.inProgressGames.*.moves.*.puzzleCurrentState', 'puzzle current state did not match whitelist').optional().whitelist("0123456789"),
    query('*.inProgressGames.*.moves.*.puzzleCurrentState', 'puzzle current state is not of correct length').optional().isLength({ min: 81, max: 81 }),
    query('*.inProgressGames.*.moves.*.puzzleCurrentNotesState', 'puzzle current notes state state did not match whitelist').optional().whitelist("01"),
    query('*.inProgressGames.*.moves.*.puzzleCurrentNotesState', 'puzzle current notes state state is not of correct length').optional().isLength({ min: 9, max: 729 }),
...
exports.validateUserActivePuzzlesBodyPATCH = [
    ...
    body('*.inProgressGames.*.moves.*.puzzleCurrentState', 'puzzle current state did not match whitelist').optional().whitelist("0123456789"),
    body('*.inProgressGames.*.moves.*.puzzleCurrentState', 'puzzle current state is not of correct length').optional().isLength({ min: 81, max: 81 }),
    body('*.inProgressGames.*.moves.*.puzzleCurrentNotesState', 'puzzle current notes state state did not match whitelist').optional().whitelist("01"),
    body('*.inProgressGames.*.moves.*.puzzleCurrentNotesState', 'puzzle current notes state state is not of correct length').optional().isLength({ min: 9, max: 729 }),
